...
// Tabla combinada Hunt-Hess/WFNS + Fisher modificada: vive en su propio modal ("Ver tabla" en la
// fila de la escala, ver expandBtn()/openEscalaExpand() en engine/study-view.js) en vez de
// incrustarse inline en la celda de la tabla de escalas. Una tabla anidada dentro de la celda de
// OTRA tabla (la de escalas) rompe el parseo del navegador: sus filas terminan como filas sueltas
// de la tabla exterior, con columnas de más a la derecha vacías.
const huntHessFisherTable = `
...
export const content = {
  diagnostico: {
    clinica: {
      ...
      <img src="topics/enfermedad-cerebrovascular/assets/territorios-vasculares-sindromes.png" alt="Infografía de los territorios vasculares cerebrales: arteria cerebral media (ACM), arteria cerebral anterior (ACA), arteria cerebral posterior (ACP) y arteria cerebelosa posteroinferior (PICA), con su irrigación principal, esquema anatómico, síndrome clínico típico y signos clave de cada uno." style="width:100%;max-width:640px;display:block;margin:0 auto;border-radius:var(--radius);border:1px solid var(--line);">
      <div class="figure-grade-box">La ACM es la más afectada por su calibre y por ser la continuación directa de la carótida interna; explica la mayoría de los ECV isquémicos de circulación anterior. Ante un síndrome de circulación posterior sin territorio claro, las "5 D" orientan: dizziness (vértigo), diplopia, dysarthria (disartria), dysphagia (disfagia), dystaxia (ataxia).</div>
      <div style="margin-top:12px;"><strong style="color:var(--accent-fg);">Síndromes lacunares clásicos.</strong> Cuando el infarto es pequeño y subcortical (oclusión de una arteria perforante), el déficit puede resumirse en uno de cinco patrones reconocibles, típicamente SIN afectar el lenguaje, la visión ni el nivel de consciencia:
      <ul style="margin:8px 0 0;padding-left:20px;color:var(--ink-dim);font-size:14.5px;line-height:1.7;">
        <li><strong>Motor puro:</strong> hemiparesia/hemiplejía de cara, brazo y pierna por igual, sin déficit sensitivo, visual ni cognitivo (el más frecuente; cápsula interna o protuberancia).</li>
        <li><strong>Sensitivo puro:</strong> hemihipoestesia/parestesias de cara, brazo y pierna, sin déficit motor (tálamo).</li>
        <li><strong>Sensitivomotor:</strong> combina los dos anteriores (tálamo con extensión a la cápsula interna adyacente).</li>
        <li><strong>Hemiparesia-ataxia:</strong> debilidad más incoordinación desproporcionada a esa debilidad, en el mismo lado (cápsula interna, protuberancia o corona radiada).</li>
        <li><strong>Disartria-mano torpe:</strong> disartria marcada más torpeza y debilidad leve de la mano, sin afectar el resto de la extremidad (protuberancia o rodilla de la cápsula interna).</li>
      </ul></div>`)}`,
      descompensada: `Además del déficit focal (que empeora progresivamente en minutos-horas, a diferencia del isquémico), predominan cefalea intensa de instalación súbita, vómito y disminución del estado de alerta. Ni la HIC ni la HSA se distinguen del isquémico de forma confiable solo por la clínica: la neuroimagen urgente es obligatoria en ambos sentidos.
      <div style="margin-top:10px;"><strong style="color:var(--accent-fg);">Hemorragia intracerebral (HIC): patrón según localización.</strong>
      <ul style="margin:8px 0 0;padding-left:20px;color:var(--ink-dim);font-size:14.5px;line-height:1.7;">
        <li><strong>Putaminal (la más frecuente):</strong> hemiparesia/hemihipoestesia contralateral, desviación de la mirada hacia el lado de la lesión, afasia si es el hemisferio dominante.</li>
        <li><strong>Talámica:</strong> déficit sensitivo prominente (más que el motor), a menudo con desviación de la mirada hacia abajo y adentro ("mirando la punta de la nariz") por compromiso del mesencéfalo adyacente.</li>
        <li><strong>Protuberancial:</strong> coma de instalación rápida, pupilas puntiformes pero reactivas, cuadriparesia; alta mortalidad por su efecto directo sobre el tronco encefálico.</li>
        <li><strong>Cerebelosa:</strong> cefalea occipital, vértigo, ataxia de la marcha, vómito; urgencia quirúrgica potencial por el riesgo de compresión del tronco/hidrocefalia obstructiva pese a un déficit focal inicial que puede parecer leve.</li>
      </ul></div>
      <div style="margin-top:10px;"><strong style="color:var(--accent-fg);">Hemorragia subaracnoidea (HSA).</strong> El síntoma cardinal es la cefalea "en trueno" (la peor de la vida del paciente, con pico de intensidad en segundos), con o sin pérdida transitoria de consciencia y signos meníngeos (rigidez de nuca, Kernig, Brudzinski); hasta 20-40% refieren una cefalea centinela (sangrado leve previo) en los días-semanas previos, que pasa desapercibida si no se interroga de forma dirigida.</div>
      <div style="margin-top:10px;"><strong style="color:var(--accent-fg);">Mimics de ECV a considerar siempre:</strong> hipoglucemia, crisis convulsiva con parálisis de Todd, migraña con aura, encefalopatía hipertensiva, trastorno funcional.</div>`
    },
    laboratorio: [
  ...
  clasificacion: {
    ...
    escalas: [
      ...
      <div class="figure-grade-box">Se resta 1 punto por cada una de las 10 regiones con hipodensidad o pérdida de la diferenciación gris-blanca temprana.</div>`)}${figBlock('Imagen 3', 'Guía visual del ASPECTS: regiones, ejemplo de puntaje e interpretación', `
      <img src="topics/enfermedad-cerebrovascular/assets/aspects-guia-visual.png" alt="Infografía guía del ASPECTS: las 10 regiones en los dos cortes axiales (nivel de ganglios basales y nivel supraganglionar), lista de cambios isquémicos tempranos a buscar, un ejemplo de puntaje 10 frente a 6, y la tabla de interpretación clínica por rango de puntaje." style="width:100%;max-width:640px;display:block;margin:0 auto;border-radius:var(--radius);border:1px solid var(--line);">
      <p style="font-size:10.5px;color:var(--ink-faint);text-align:center;margin:8px 0 0;">Resumen visual del método de puntuación; las TC de este esquema son ilustrativas, no sustituyen a la TC real de la Imagen 2 para reconocer el hallazgo en un paciente.</p>`)}` },
      ...
      { nombre: 'ASTRAL score', componentes: 'Nombre: Acute STroke Registry and Analysis of Lausanne. Edad, gravedad por NIHSS, tiempo desde el inicio de los síntomas hasta la atención, presencia de un defecto de campo visual nuevo, glucosa anormal al ingreso, y alteración del nivel de consciencia.', formula: '1 punto por cada 5 años de edad + 1 punto por cada punto de NIHSS al ingreso + 2 puntos si han pasado más de 3 horas desde el inicio + 2 puntos si hay defecto de campo visual + 1 punto si la glucosa es &gt;131 o &lt;66 mg/dL + 3 puntos si hay alteración de consciencia. Suma abierta, sin techo fijo.', interpretacion: 'A mayor puntaje, mayor probabilidad de mal resultado funcional (Rankin &gt;2) a los 90 días; es un score pronóstico del ECV isquémico ya establecido, distinto del ABCD2 (que predice el riesgo de un evento después de un AIT, no el desenlace de un infarto ya ocurrido).' },
      { nombre: 'iScore', componentes: 'Nombre: Ischemic Stroke Predictive Score (registro de Ontario, Canadá). Edad, sexo masculino, gravedad del déficit, subtipo de ECV (no lacunar tiene peor pronóstico), glucosa al ingreso ≥135 mg/dL, fibrilación auricular, cardiopatía isquémica, insuficiencia cardiaca, cáncer activo, enfermedad renal en diálisis, y dependencia funcional previa al evento.', formula: 'Calculadora en línea con ponderación propia por variable (sin una tabla simple de puntos enteros como el ASTRAL); requiere la herramienta web para el cálculo exacto.', interpretacion: 'Estima la mortalidad a 30 días y al año tras un ECV isquémico; también se ha usado para estimar qué tanto se beneficiaría un paciente concreto de la trombólisis, más allá de si es o no elegible por ventana de tiempo.' },
      { nombre: 'Essen Stroke Risk Score (ESRS)', componentes: 'Edad, hipertensión arterial, diabetes mellitus, infarto de miocardio previo, otra enfermedad cardiovascular, enfermedad arterial periférica, tabaquismo, y antecedente de AIT o ECV isquémico adicional al evento que motiva la evaluación.', formula: '2 puntos si edad &gt;75 años, 1 punto si edad 65-75 años; 1 punto cada uno por hipertensión, diabetes, infarto de miocardio previo, otra enfermedad cardiovascular, enfermedad arterial periférica, tabaquismo, y AIT/ECV previo adicional. Suma, 0-9.', interpretacion: '0-2 riesgo bajo de recurrencia; ≥3 riesgo alto de recurrencia (ECV o muerte cardiovascular) al año. A diferencia del ABCD2 (agudo, para un AIT reciente) y del TOAST (etiología), el ESRS se usa en la consulta de seguimiento para decidir la intensidad de la prevención secundaria a largo plazo.' },
      ...
      { nombre: 'Hunt y Hess / WFNS', componentes: 'Nombre: Hunt y Hess; WFNS = World Federation of Neurosurgical Societies (Federación Mundial de Sociedades de Neurocirugía). Nivel de consciencia y déficit motor al ingreso en la HSA.', formula: 'Hunt-Hess: 5 grados clínicos (I-V). WFNS: combina Glasgow + déficit motor, también 5 grados.', interpretacion: `Correlaciona con la mortalidad quirúrgica y guía el momento de la intervención; el WFNS es más objetivo y reproducible (basado en Glasgow), y es el estándar actual en ensayos clínicos.`, expandTitulo: 'Tabla · Hunt-Hess/WFNS y Fisher/Fisher modificada', expandHtml: huntHessFisherTable },
      { nombre: 'Fisher / Fisher modificada', componentes: 'Cuantía y distribución de la sangre subaracnoidea, con o sin hemorragia intraventricular, en la TC de ingreso.', formula: 'Fisher original: 4 grados. Fisher modificada: 0-4, incorpora la HIV.', interpretacion: 'Predice el riesgo de vasoespasmo/isquemia cerebral tardía; la Fisher modificada añade la hemorragia intraventricular como factor independiente de mayor riesgo.', expandTitulo: 'Tabla · Hunt-Hess/WFNS y Fisher/Fisher modificada', expandHtml: huntHessFisherTable },
  ...
  complicaciones: [
    {
      ...
      tx_farmacologico: 'Doble antiagregación (ácido acetilsalicílico 160-300 mg de carga seguido de 75-100 mg/día + clopidogrel 300-600 mg de carga seguido de 75 mg/día) por 21 días en el AIT de alto riesgo (ABCD2 ≥4), iniciada dentro de las primeras 12-24 horas y seguida de monoterapia (evidencia de CHANCE/POINT); anticoagulación si se confirma fibrilación auricular, una vez descartado un infarto extenso; estatina de alta intensidad (p. ej. atorvastatina 40-80 mg/día o rosuvastatina 20-40 mg/día); control estricto de la presión arterial.',
    ...
    },
    {
      ...
      tx_farmacologico: 'Osmoterapia como puente a la cirugía (no sustituye a la hemicraniectomía en el infarto maligno establecido): solución salina hipertónica al 3% (bolo de 250-300 mL o infusión continua) o manitol 0.25-1 g/kg IV en bolo cada 4-6 horas según respuesta; evitar corticoides, sin beneficio y con riesgo en el edema citotóxico, a diferencia del edema vasogénico tumoral.',
    ...
    },
    {
      ...
      imagen: `Angio-RM/angio-TC venosa de elección; la TC simple puede mostrar el signo de la cuerda densa (trombo hiperdenso en el seno) o ser normal.${figBlock('Imagen 6', 'TC simple: trombosis del seno transverso (signo de la cuerda densa)', `
      <img src="https://upload.wikimedia.org/wikipedia/commons/5/55/Duralvenoussinusthrombosis.png" alt="TC simple de cráneo con hiperdensidad del seno transverso derecho (flecha), mayor que el izquierdo, correspondiente a trombo agudo" style="width:100%;max-width:340px;display:block;margin:0 auto;border-radius:var(--radius);border:1px solid var(--line);">
      <p style="font-size:10.5px;color:var(--ink-faint);text-align:center;margin:8px 0 0;">Trombosis del seno venoso dural transverso (flecha), de mayor extensión en el lado derecho que en el izquierdo. James Heilman, MD, Wikimedia Commons, CC BY-SA 4.0.</p>`)}`,
      ...
      tx_farmacologico: 'Anticoagulación sistémica como tratamiento de primera línea, incluso en presencia de transformación hemorrágica: el infarto venoso hemorrágico NO es contraindicación para anticoagular, a diferencia del ECV arterial hemorrágico. Heparina de bajo peso molecular (enoxaparina 1 mg/kg subcutánea cada 12 horas) o heparina no fraccionada IV en infusión ajustada por TTPa si se prefiere una vida media corta (p. ej. riesgo de deterioro que amerite un procedimiento); puente a anticoagulación oral por 3-12 meses según si el factor de riesgo es transitorio o permanente.',
    ...
    },
    {
      ...
      criterios_dx: `TC simple de cráneo que demuestra hiperdensidad intraparenquimatosa aguda; el "signo de la mancha" (spot sign) en la angio-TC identifica sangrado activo y predice la expansión del hematoma.${figBlock('Imagen 7', 'TC simple: hemorragia intracerebral hipertensiva de ganglios basales', `
      ...
      tx_farmacologico: 'Reducción intensiva y rápida de la presión arterial, con objetivo de presión sistólica menor a 140 mmHg dentro de la primera hora (evidencia de INTERACT2, sin aumento de eventos isquémicos y con tendencia a mejor desenlace funcional; ATACH-2 no mostró beneficio adicional de metas más agresivas cercanas a 120 y sí más eventos renales, por lo que menor a 140 es el objetivo práctico). Reversión inmediata de la anticoagulación según el fármaco causante: warfarina → concentrado de complejo protrombínico de 4 factores (25-50 UI/kg según el INR) más vitamina K 10 mg IV; dabigatrán → idarucizumab 5 g IV (dos dosis de 2.5 g); inhibidores directos del factor Xa (rivaroxabán, apixabán) → andexanet alfa (dosis según el fármaco y la última toma) o, si no está disponible, concentrado de complejo protrombínico 50 UI/kg; heparina no fraccionada → protamina 1 mg IV por cada 100 UI de heparina recibidas en las últimas horas.',
    ...
    },
    {
      ...
      criterios_dx: `TC simple de cráneo, con sensibilidad mayor a 95% en las primeras 6 horas del inicio de la cefalea (decrece con el tiempo); si la TC es negativa con alta sospecha clínica y han pasado más de 6 horas, punción lumbar buscando xantocromía (sobrenadante amarillento por degradación de hemoglobina, más específica que el simple recuento de eritrocitos, que puede deberse a una punción traumática) o RM con secuencias sensibles a sangre (FLAIR/SWI).${figBlock('Imagen 8', 'TC simple: hemorragia subaracnoidea en las cisternas basales', `
    ...
    },
    {
      ...
      tx_farmacologico: 'Continuar el nimodipino 60 mg VO/SNG cada 4 horas (o 30 mg cada 2 horas si hay hipotensión con la dosis estándar), ya iniciado desde el diagnóstico de la HSA; vasopresores (noradrenalina, titulada por objetivo de presión arterial media) para lograr la hipertensión inducida terapéutica una vez que el aneurisma está asegurado.',
    ...
    },
    {
      ...
      tx_farmacologico: 'Tratar la crisis clínica aguda con benzodiacepina de rescate (lorazepam 0.1 mg/kg IV o diazepam 0.15-0.2 mg/kg IV), seguida de un antiepiléptico de mantenimiento (levetiracetam 500-1000 mg IV/VO cada 12 horas, con carga de 60 mg/kg si la crisis fue reciente, es de primera elección por su perfil de interacciones favorable y disponibilidad IV); la duración del tratamiento tras una crisis sintomática aguda aislada suele ser corta (semanas), a diferencia de la epilepsia postictus tardía, que requiere tratamiento prolongado.',
  ...
  seguimiento_intrahospitalario: {
    ...
    prevencion: 'Prevención secundaria dirigida por etiología: control estricto de la presión arterial (el factor modificable más importante en ambos tipos de ECV), antiagregación o anticoagulación según corresponda, estatina de alta intensidad (p. ej. atorvastatina 40-80 mg/día) en el isquémico aterotrombótico, cese del tabaquismo, control glucémico, y corrección quirúrgica/endovascular de la fuente estructural identificada (estenosis carotídea, aneurisma adicional, foramen oval permeable en el ECV criptogénico del joven). Las dosis específicas de cada fármaco por escenario agudo se detallan en la tarjeta de cada entidad, en Complicaciones.'
  }
};
