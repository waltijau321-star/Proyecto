...
<p style="margin:0 0 14px;"><strong style="color:var(--accent-fg);">Etiología y clasificación.</strong> El ECV isquémico se subclasifica por mecanismo según los criterios TOAST: aterotrombótico de gran vaso, cardioembólico (la fibrilación auricular es la causa más frecuente), oclusión de pequeño vaso (lacunar), otra etiología determinada (disección, vasculitis, estados protrombóticos) o indeterminada; la trombosis de senos venosos es una categoría aparte, de mecanismo isquémico pero de origen venoso, no arterial. El ECV hemorrágico se clasifica por localización: la hemorragia intracerebral (HIC) es intraparenquimatosa, típicamente por hipertensión arterial crónica en localización profunda (ganglios basales, tálamo, protuberancia, cerebelo) o por angiopatía amiloide cerebral en el anciano (localización lobar); la hemorragia subaracnoidea (HSA) es extraaxial, en la gran mayoría de los casos por rotura de un aneurisma sacular.</p>
<p style="margin:0 0 14px;"><strong style="color:var(--accent-fg);">Factores de riesgo.</strong> Modificables (los que más impactan la prevención): hipertensión arterial (el más importante, compartido entre isquémico y hemorrágico), fibrilación auricular, diabetes mellitus, dislipidemia, tabaquismo, estenosis carotídea, consumo de alcohol, y factores hormonales o protrombóticos (embarazo, puerperio, anticonceptivos con estrógenos) para la trombosis venosa. No modificables: edad avanzada, sexo (predominio femenino en la incidencia global acumulada por mayor esperanza de vida; predominio masculino específico en la hemorragia subaracnoidea hasta la menopausia), ascendencia (mayor incidencia de hemorragia intracerebral en poblaciones asiática y afrodescendiente), y predisposición genética (enfermedad renal poliquística y síndrome de Ehlers-Danlos vascular para el aneurisma intracraneal).</p>
...
export const content = {
  ...
  clasificacion: {
    ...
    escalas: [
      ...
      { nombre: 'ASPECTS', componentes: 'Diez regiones del territorio de la ACM en la TC simple: caudado, lentiforme, cápsula interna, ínsula, y M1-M6 (corteza a nivel ganglionar y supraganglionar).', formula: '10 menos 1 punto por cada región con hipodensidad/pérdida de diferenciación gris-blanca temprana', interpretacion: `10 = TC normal. ≥6 identifica candidatos razonables a trombectomía; &lt;6 sugiere infarto ya extenso, con mayor riesgo de transformación hemorrágica y peor respuesta a la reperfusión.${figBlock('Tabla 2', 'Grid ASPECTS (10 regiones)', `
  ...
  complicaciones: [
    ...
    },
    {
      ...
      imagen: 'TC simple inmediata (excluye hemorragia); angio-TC de cabeza y cuello (identifica oclusión de gran vaso); TC de perfusión o RM-difusión para cuantificar núcleo/penumbra en la ventana extendida; ASPECTS calculado sobre la TC simple.',
    ...
    },
    {
      ...
      criterios_dx: 'TC simple de cráneo que demuestra hiperdensidad intraparenquimatosa aguda; el "signo de la mancha" (spot sign) en la angio-TC identifica sangrado activo y predice la expansión del hematoma.',
    ...
    },
    {
      ...
      criterios_dx: 'TC simple de cráneo, con sensibilidad mayor a 95% en las primeras 6 horas del inicio de la cefalea (decrece con el tiempo); si la TC es negativa con alta sospecha clínica y han pasado más de 6 horas, punción lumbar buscando xantocromía (sobrenadante amarillento por degradación de hemoglobina, más específica que el simple recuento de eritrocitos, que puede deberse a una punción traumática) o RM con secuencias sensibles a sangre (FLAIR/SWI).',
