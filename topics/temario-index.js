...
const NEUMOLOGIA_R1_CLUSTERS = [
  { name: 'Enfermedad respiratoria crónica', items: [{ label: 'EPOC estable y exacerbación', topicId: 'epoc' }, { label: 'Asma', topicId: 'asma' }, { label: 'Enfermedad pulmonar intersticial difusa', topicId: 'enfermedad-intersticial' }, { label: 'Hipertensión pulmonar', topicId: 'hipertension-pulmonar' }, { label: 'Enfermedad pulmonar restrictiva', topicId: 'enfermedad-intersticial' }, { label: 'Nódulo pulmonar solitario y cáncer de pulmón', topicId: 'nodulo-cancer-pulmon' }, { label: 'Apnea obstructiva del sueño', topicId: 'apnea-sueno' }, { label: 'Sarcoidosis y otras enfermedades granulomatosas', topicId: 'sarcoidosis' }, { label: 'Bronquiectasias', topicId: 'bronquiectasias' }, { label: 'Neumoconiosis', topicId: 'enfermedad-intersticial' }] },
  { name: 'Infecciones respiratorias', items: [{ label: 'Neumonía adquirida en la comunidad y nosocomial', topicId: 'neumonia' }, { label: 'Neumonía por aspiración', topicId: 'neumonia' }, { label: 'Tuberculosis', topicId: 'tuberculosis' }, { label: 'Absceso pulmonar', topicId: 'neumonia' }, { label: 'COVID-19 y sus complicaciones', topicId: 'neumonia' }, { label: 'Influenza y neumonía viral', topicId: 'neumonia' }, { label: 'Bronquitis aguda', topicId: 'bronquitis-aguda' }] },
...
export const temarioBlocks = [
  ...
  },
  {
    ...
    clusters: [
      ...
      { name: 'Tiroides y paratiroides', items: [{ label: 'Hipotiroidismo (primario, central y subclínico)', topicId: 'hipotiroidismo' }, { label: 'Hipertiroidismo y tiroiditis', topicId: 'hipertiroidismo-tiroiditis' }, { label: 'Bocio difuso y multinodular no tóxico', topicId: 'nodulo-cancer-tiroides' }, { label: 'Tormenta tiroidea y coma mixedematoso', topicId: 'urgencias-tiroideas' }, { label: 'Nódulo tiroideo', topicId: 'nodulo-cancer-tiroides' }, { label: 'Trastornos del metabolismo óseo y mineral (paratiroides, hiper e hipocalcemia)', topicId: 'metabolismo-oseo-mineral' }, { label: 'Neoplasias del tiroides', topicId: 'nodulo-cancer-tiroides' }] },
