...
export const temarioBlocks = [
  ...
  },
  {
    ...
    clusters: [
      { name: 'Diabetes mellitus', items: [{ label: 'Diagnóstico y metas de control en tipo 1 y tipo 2', topicId: 'diabetes-mellitus' }, 'Cetoacidosis diabética y estado hiperosmolar hiperglucémico', { label: 'Complicaciones crónicas microvasculares y macrovasculares', topicId: 'diabetes-mellitus' }, { label: 'Pie diabético', topicId: 'diabetes-mellitus' }, { label: 'Hipoglucemia y diabetes gestacional', topicId: 'diabetes-mellitus' }] },
