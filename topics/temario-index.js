...
export const temarioBlocks = [
  ...
  },
  {
    ...
    clusters: [
      ...
      { name: 'Hemostasia y trombosis', items: [{ label: 'Trastornos de la coagulación y trombofilias', topicId: 'coagulacion-trombofilias' }, 'Trombocitopenia y púrpuras', 'Trombocitosis reactiva', 'Transfusión de hemoderivados', 'Coagulación intravascular diseminada'] },
