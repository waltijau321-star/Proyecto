...
export const temarioBlocks = [
  ...
  },
  {
    ...
    clusters: [
      ...
      { name: 'Neoplasias hematológicas', items: [{ label: 'Síndromes mielodisplásicos (bajo riesgo, alto riesgo, hipoplásico, relacionado a tratamiento)', topicId: 'sindromes-mielodisplasicos' }, { label: 'Neoplasias mieloproliferativas (policitemia vera, trombocitemia esencial, mielofibrosis)', topicId: 'sindromes-mieloproliferativos' }, { label: 'Leucemia aguda (LMA, LPA, LLA)', topicId: 'leucemia-aguda' }, 'Leucemia linfocítica crónica', 'Linfomas, incluyendo linfoma de Hodgkin', 'Mieloma múltiple', 'Linfadenopatías, hiperesplenismo y síndrome de hiperviscosidad'] },
