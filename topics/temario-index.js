...
export const temarioBlocks = [
  ...
  },
  {
    ...
    clusters: [
      { name: 'Anemias y trastornos de la serie roja', items: [{ label: 'Anemia ferropénica (pérdida de sangre, aporte/absorción, embarazo, refractaria)', topicId: 'anemia-ferropenica' }, 'Anemia megaloblástica (deficiencia de B12 y folato)', { label: 'Anemias hemolíticas hereditarias (esferocitosis, eliptocitosis, deficiencia de G6PD, deficiencia de piruvato cinasa)', topicId: 'anemias-hemoliticas-hereditarias' }, { label: 'Anemias hemolíticas adquiridas (autoinmunes, microangiopáticas, HPN)', topicId: 'anemias-hemoliticas-adquiridas' }, 'Anemia de la enfermedad crónica', 'Policitemia secundaria (eritrocitosis)', 'Alteraciones de la serie blanca (leucocitosis, leucopenia, eosinofilia)', 'Porfirias', { label: 'Anemia aplásica (idiopática, no grave, secundaria, congénita)', topicId: 'anemia-aplasica' }, 'Hemoglobinopatías (talasemias, drepanocitosis)'] },
