...
export const temarioBlocks = [
  ...
  },
  {
    ...
    clusters: [
      { name: 'Anemias y trastornos de la serie roja', items: ['Anemia ferropénica y megaloblástica', { label: 'Anemias hemolíticas hereditarias (esferocitosis, eliptocitosis, deficiencia de G6PD, deficiencia de piruvato cinasa)', topicId: 'anemias-hemoliticas-hereditarias' }, 'Anemias hemolíticas adquiridas (autoinmunes, microangiopáticas)', 'Anemia de la enfermedad crónica', 'Policitemia secundaria (eritrocitosis)', 'Alteraciones de la serie blanca (leucocitosis, leucopenia, eosinofilia)', 'Porfirias', { label: 'Anemia aplásica (idiopática, no grave, secundaria, congénita)', topicId: 'anemia-aplasica' }, 'Hemoglobinopatías (talasemias, drepanocitosis)'] },
