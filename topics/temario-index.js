...
export const temarioBlocks = [
  ...
  },
  {
    ...
    clusters: [
      ...
      { name: 'Hemostasia y trombosis', items: [{ label: 'Trastornos de la coagulación y trombofilias', topicId: 'coagulacion-trombofilias' }, { label: 'Alteraciones plaquetarias cuantitativas (trombocitopenia y púrpuras, trombocitosis reactiva)', topicId: 'alteraciones-plaquetarias-cuantitativas' }, 'Transfusión de hemoderivados', 'Coagulación intravascular diseminada'] },
