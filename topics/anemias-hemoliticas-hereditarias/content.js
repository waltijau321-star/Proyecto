...
export const meta = {
  ...
  subtitulo: 'Módulo 11 · Medicina Interna',
  accent: '#5c4a7a',
  accentDim: '#8a7ab0'
};
...
<p style="margin:10px 0 0;font-size:13.5px;color:var(--ink-dim);">Analogía: una membranopatía es como una casa con paneles estructurales defectuosos (el citoesqueleto), que va perdiendo pedazos de su propia estructura cada vez que pasa por un control exigente (el bazo), hasta quedar tan encogida y rígida que el control de calidad la retira de circulación de forma permanente. Una enzimopatía es distinta: la casa nace estructuralmente sana, pero su sistema contra incendios (las enzimas antioxidantes, o la producción de energía) está fallado, por lo que sobrevive bien en condiciones normales y solo se incendia (hemólisis) cuando aparece un fuego real, como un fármaco oxidante o una infección.</p>`)}</p>
