...
<p style="margin:4px 0 0;">Los nociceptores periféricos transducen el estímulo lesivo y lo transmiten por dos tipos de fibra: las <strong>Aδ</strong> (mielinizadas, conducción rápida) generan el "primer dolor" — agudo, bien localizado, como la sensación instantánea y precisa de pisar una tachuela; las <strong>C</strong> (amielínicas, conducción lenta) generan el "segundo dolor" — sordo, difuso, persistente, como el ardor sostenido que queda después. Ambas hacen sinapsis en el asta dorsal medular, decusan, y ascienden por el tracto espinotalámico lateral hacia el tálamo y la corteza somatosensorial.</p>
...
<li style="margin-bottom:4px;"><strong>Nociceptivo somático</strong> (piel, músculo, hueso, articulaciones): el sistema nervioso tiene un mapa de alta resolución de estas estructuras —como una fotografía nítida— por eso el paciente puede señalar el punto exacto con un dedo, y el dolor se agrava claramente con el movimiento o la presión local.</li>
<li style="margin-bottom:4px;"><strong>Nociceptivo visceral</strong> (vísceras huecas y sólidas): el mapa neural de las vísceras es mucho menos detallado —como una fotografía borrosa o fuera de foco— por eso el dolor es difuso, mal localizado, y el paciente típicamente lo señala con toda la mano abierta sobre una región amplia, no con un dedo.</li>
<li><strong>Neuropático</strong> (lesión del propio sistema nervioso, no del tejido que duele): es como un cable eléctrico pelado que sigue mandando señal aunque nadie lo esté tocando — el dolor es quemante, con descargas eléctricas y disestesias, y ocurre sin que haya ningún estímulo lesivo actual en el territorio donde se siente.</li>
</ul>
<p style="margin:8px 0 0;">El <strong>dolor referido</strong> se explica por el mecanismo de convergencia-proyección de Ruch: las neuronas de segundo orden del asta dorsal reciben aferencias viscerales y somáticas del mismo segmento medular —comparten el mismo "cable" hacia el cerebro— y la corteza, que nunca aprendió a distinguir el origen exacto de esa señal compartida, la interpreta como si viniera del territorio somático, no del visceral real (ver figura). La inflamación local sensibiliza los nociceptores (bradicinina, prostaglandinas, sustancia P — sensibilización periférica, como bajar el volumen necesario para disparar la alarma) y puede amplificar la respuesta a nivel medular (sensibilización central: hiperalgesia, alodinia — la alarma se dispara incluso con un roce que normalmente no dolería).</p>
</div>
<div>
...
<p style="margin:4px 0 0;">Por duración: <strong>agudo</strong> (&lt;3 meses, cumple una función protectora clara) o <strong>crónico</strong> (≥3 meses, ya perdió buena parte de su valor de alarma y se convierte en la enfermedad misma).</p>
    ...
    },
    {
      ...
      fisiopatologia: `<div style="margin-bottom:14px;">
<strong style="color:#8c3a34;">Mecanismo</strong>
<p style="margin:4px 0 0;">Los pirógenos exógenos (lipopolisacárido bacteriano, toxinas, componentes virales) activan monocitos/macrófagos, que liberan pirógenos endógenos — principalmente IL-1β, IL-6 y TNF-α. Estas citocinas actúan sobre el órgano vascular de la lámina terminal (OVLT), una región del hipotálamo anterior con barrera hematoencefálica fenestrada, e inducen la expresión de COX-2 local, generando prostaglandina E2 (PGE2). La PGE2 se une a receptores EP3 en el núcleo preóptico ventromedial y eleva el punto de ajuste ("set point") termorregulador hipotalámico. Es, literalmente, como subir el termostato de una casa: el cuerpo no está "descompuesto", está persiguiendo activamente una temperatura objetivo más alta — por eso genera y conserva calor (vasoconstricción cutánea, escalofríos, conducta de abrigo) hasta alcanzar ese nuevo set point, igual que una calefacción que enciende y no se apaga hasta llegar al número marcado en el termostato.</p>
<p style="margin:8px 0 0;">Los antipiréticos (AINEs, paracetamol) inhiben la COX y reducen la PGE2 — bajan el termostato de vuelta a su posición normal. Por eso NO son eficaces en la <strong>hipertermia</strong>, donde el termostato nunca se movió: el problema ahí es que el sistema de enfriamiento (sudoración, vasodilatación) falla o es insuficiente frente a una ganancia de calor excesiva (golpe de calor, hipertermia maligna, síndrome neuroléptico maligno, síndrome serotoninérgico) — como intentar enfriar una casa bajando el termostato cuando en realidad el aire acondicionado está apagado.</p>
</div>
<div style="margin-bottom:14px;">
...
<p style="margin:4px 0 0;">Aguda (&lt;2 semanas) vs. fiebre de origen desconocido (FOD). Los criterios clásicos de Petersdorf para FOD son: temperatura &gt;38.3 °C en varias ocasiones, duración &gt;3 semanas, y ausencia de diagnóstico pese a al menos una semana de estudio hospitalario adecuado (los criterios modernos de Durack y Street ya no exigen la hospitalización, y distinguen subcategorías: FOD clásica, nosocomial, neutropénica y asociada a VIH). Ante una FOD, el diferencial se amplía más allá de lo infeccioso, hacia causas neoplásicas (linfoma, hipernefroma), autoinmunes (arteritis de células gigantes, enfermedad de Still) y farmacológicas.</p>
    ...
    },
    {
      ...
      fisiopatologia: `<div style="margin-bottom:14px;">
<strong style="color:#8c3a34;">Mecanismo</strong>
<p style="margin:4px 0 0;">El reflejo tusígeno se inicia en receptores de adaptación rápida (RARs) y fibras C sensibles a irritantes mecánicos/químicos, ubicados en laringe, tráquea y bronquios de gran calibre. La señal aferente viaja por el nervio vago hasta el centro de la tos en el bulbo raquídeo, que coordina 3 fases — como disparar un extintor: primero se "carga" (fase inspiratoria: inspiración profunda), luego se "presuriza" (fase compresiva: cierre glótico con contracción espiratoria forzada, generando presión intratorácica elevada), y por último se "dispara" (fase expulsiva: apertura súbita de la glotis con flujo espiratorio explosivo que arrastra secreciones o cuerpos extraños).</p>
</div>
<div>
<strong style="color:#8c3a34;">Clasificación</strong>
