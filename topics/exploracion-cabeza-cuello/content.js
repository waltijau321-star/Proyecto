...
export const content = {
  ...
  complicaciones: [
    ...
    },
    {
      ...
      fisiopatologia: 'El quiste tirogloso es un remanente del conducto tirogloso (el trayecto embrionario que sigue la tiroides al descender desde la base de la lengua hasta su posición final), por lo que se ELEVA con la protrusión de la LENGUA —a diferencia de la glándula tiroides, que se eleva con la deglución—. El quiste branquial es un remanente del segundo arco branquial embrionario y NO se mueve ni con la deglución ni con la protrusión lingual.',
