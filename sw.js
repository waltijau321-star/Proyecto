...
const CACHE_VERSION = 'residentemed-ca6ce79e23';
const CORE = [
  './',
  './index.html',
  './app.js',
  ...
  './topics/alteraciones-plaquetarias-cuantitativas/content.js',
  './topics/alteraciones-plaquetarias-cuantitativas/calculators.js',
  './topics/alteraciones-plaquetarias-cuantitativas/study.js',
  './topics/transfusion-hemoderivados/content.js',
  './topics/transfusion-hemoderivados/calculators.js',
  './topics/transfusion-hemoderivados/study.js',
  ...
  './topics/sindrome-aortico-agudo/content.js',
  './topics/sindrome-aortico-agudo/calculators.js',
  './topics/sindrome-aortico-agudo/study.js',
  './topics/trastornos-del-movimiento/content.js',
  './topics/trastornos-del-movimiento/calculators.js',
  './topics/trastornos-del-movimiento/study.js',
  './topics/esclerosis-multiple/content.js',
  './topics/esclerosis-multiple/calculators.js',
  './topics/esclerosis-multiple/study.js',
  './topics/delirium-coma-encefalopatias/content.js',
  './topics/delirium-coma-encefalopatias/calculators.js',
  './topics/delirium-coma-encefalopatias/study.js',
  './topics/embolia-grasa/content.js',
  './topics/embolia-grasa/calculators.js',
  './topics/embolia-grasa/study.js',
  './topics/embolia-grasa/assets/teorias-fisiopatologicas.png',
  './topics/embolia-grasa/assets/distribucion-purpura-petequial.png',
